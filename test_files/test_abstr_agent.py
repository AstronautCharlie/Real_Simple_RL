...
def test_generate_action_rollout(states, num_steps):
    """
    ...
    for state in states:
        ...
        rollout = agent.generate_action_rollout(mdp_state, num_steps)
        print('Generating roll-out from', state, ':', rollout)
...
if __name__ == '__main__':
    ...
    test_generate_action_rollout(states, 2)
